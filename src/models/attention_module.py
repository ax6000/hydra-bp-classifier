...
from ram1d import RAM_ResidualBlock as ResidualBlock
...
class AttentionModule_pre(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1, size2, size3):
        ...
        self.interpolation3 = nn.UpsamplingBilinear1d(size=size3)

        self.softmax4_blocks = ResidualBlock(in_channels, out_channels)

        self.interpolation2 = nn.UpsamplingBilinear1d(size=size2)

        self.softmax5_blocks = ResidualBlock(in_channels, out_channels)

        self.interpolation1 = nn.UpsamplingBilinear1d(size=size1)
...
class AttentionModule_stage0(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(112, 112), size2=(56, 56), size3=(28, 28), size4=(14, 14)):
        ...
        self.interpolation4 = nn.UpsamplingBilinear1d(size=size4)
        self.softmax5_blocks = ResidualBlock(in_channels, out_channels)
        self.interpolation3 = nn.UpsamplingBilinear1d(size=size3)
...
class AttentionModule_stage1_cifar(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(16, 16), size2=(8, 8)):
        ...
        self.interpolation1 = nn.UpsamplingBilinear1d(size=size2)  # 8*8

        self.up_residual_blocks1 = ResidualBlock(in_channels, out_channels)

        self.interpolation2 = nn.UpsamplingBilinear1d(size=size1)  # 16*16
...
class AttentionModule_stage2_cifar(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size=(8, 8)):
        ...
        self.mpool1 = nn.MaxPool1d(kernel_size=3, stride=2, padding=1)  # 4*4
        ...
        self.interpolation1 = nn.UpsamplingBilinear1d(size=size)  # 8*8
