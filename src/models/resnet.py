...
class ResNet(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(in_channels, self.inplanes, kernel_size=first_layer_kernel_size, stride=2, padding=3, bias=False)
        ...
        self.fc = nn.Linear(self.n_channels[4] * block.expansion, num_classes)
